# Numerical Experiments for "A Fast MM Algorithm for Group Lasso" – README

This repository contains Julia scripts used to generate the simulation and data analysis results in the paper "A Fast MM Algorithm for Group Lasso". The output files are produced in CSV format. The scripts are organized into three main folders:
- **Simulations**
- **Real Data**
- **Pseudo Real Data**
...
Running run_all.jl will traverse and run all experiment scripts.
...
Please refer to this README for an overview of the outputs and guidance on interpreting the CSV files generated by the simulations.
