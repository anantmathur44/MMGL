...
This repository contains Julia scripts used to generate the simulation and data analysis results the paper "A Fast MM Algorthm for Group Lasso". The output files are produced in CSV format. The scripts are organized into three main folders:
- **Simulations**
- **Real Data**
- **Pseudo Real Data**
